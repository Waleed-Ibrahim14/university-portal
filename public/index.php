	...
	<div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
		<div class="inner">
			<div class="app-card-body p-3 p-lg-4">
				<h3 class="mb-3" >Welcome, <small style="color: green;"><?php echo $id ?></small> </h3>
				<div class="row gx-5 gy-3">
					<div class="col-12 col-lg-12">
						<div>We are thrilled to have you join our university community. Our portal is designed to provide you with easy access to important academic resources, updates, and services.
						You can now view your course schedule, register for classes, check your grades, and stay updated with the latest university news and events.
						We encourage you to explore the portal and familiarize yourself with all the features. If you have any questions or need assistance, our support team is always ready to help.
						Thank you for choosing our university. We look forward to supporting you in your academic journey.
						<p>Best regards,</p>
						<p>The University Portal Team</p></div>
					</div><!--col-->
				</div><!--row-->
			</div><!--app-card-body-->
		</div><!--inner-->
