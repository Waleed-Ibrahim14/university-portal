						    ...
						    <div class="app-card-header p-3 border-bottom-0">
						        <div class="row align-items-center gx-3">
							        <div class="col-auto">
										...
										<img src="../<?php echo $user->profile;?>" alt="user profile" style="width: 24px;height: 24px;">
									    </div><!--//icon-holder-->
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    ...
										    <div class="item-data"><img src="../assets/images/users/<?php echo $_SESSION['profile']?>" alt="user profile" style="width: 24px;height: 24px;"></div>
									    </div><!--//col-->
						    ...
						    <div class="app-card-body px-4 w-100">
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    ...
									    <div class="col text-end">
										    <a class="btn-sm app-btn-secondary" href="password-reset-form.php">Change</a>
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
