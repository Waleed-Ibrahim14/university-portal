...
include_once("includes/user-activation-prosses.php");
?>
<!DOCTYPE html>
<html lang="en"> 
<head>
...
<body class="app app-reset-password p-0">    	
	...
	if ($_SESSION['user_status']  == 'active' ) { 
		...
		Welcome to our website <b style="color: green;font-size: x-large;">"'.$_SESSION['username'].'"</b> ! We’re glad you’ve joined us.Your account has been successfully registered, but there’s one final step required to activate your account.Please check the email address you registered with us	
	</div>
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="auth-form resetpass-form">                
